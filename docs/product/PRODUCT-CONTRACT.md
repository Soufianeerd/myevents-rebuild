...
- **IMPORTANT** : Legacy screen requirements (ex: `requirements.json`, `atomic-requirements.json`, `TRACEABILITY-MATRIX.md`) are visual traceability artifacts and MUST NOT override PRODUCT-SPEC.
